...
Snapshot date: 2026-05-16. Restart 35 is closed at pushed commit `465a9b4`; restart 36 is the active fix sweep from `465a9b4`.
...
| **pytest tests collected** | 2,379 | `python -m pytest helixc/tests --collect-only -q` during restart 36 fix verification |
