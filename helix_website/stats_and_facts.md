...
Snapshot date: 2026-05-15, Stage 35 restart 26 fix verification.
...
| **pytest tests collected** | 2,294 | `python -m pytest helixc/tests --collect-only -q -p no:cacheprovider` during restart 26 fix verification |
