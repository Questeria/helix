...
Snapshot date: 2026-05-16, Stage 35 restart 35 fix verification from audit baseline `fcfc20e`.
...
| **pytest tests collected** | 2,376 | `python -m pytest helixc/tests --collect-only -q` during restart 35 fix verification |
