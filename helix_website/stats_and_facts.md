...
Snapshot date: 2026-05-15, Stage 35 restart 25 fix verification.
...
| **pytest tests collected** | 2,291 | `python -m pytest helixc/tests --collect-only -q -p no:cacheprovider` during restart 25 fix verification |
