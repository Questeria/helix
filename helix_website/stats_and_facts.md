...
Snapshot date: 2026-05-16. Restart 39 is the latest recorded Stage 35 fix verification in this file; use live `git log -1 --oneline` before publishing.
...
| **pytest tests collected** | 2,391 | `python -m pytest helixc/tests --collect-only -q` during restart 39 fix verification |
