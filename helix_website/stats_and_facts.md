...
Snapshot date: 2026-05-15, Stage 35 restart 19 audit cleanup.
...
| **pytest tests collected** | 2,254 | `python -m pytest helixc/tests --collect-only -q -p no:cacheprovider` during restart 19 fix sweep |
