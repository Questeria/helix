...
Snapshot date: 2026-05-16, Stage 35 restart 34 fix verification.
...
| **pytest tests collected** | 2,372 | `python -m pytest helixc/tests --collect-only -q` during restart 34 fix verification |
