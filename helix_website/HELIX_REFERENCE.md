...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,354 tests collected in restart 32 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,354 live tests collected** — restart 32 fix verification; rerun scoped pytest collection before publishing
