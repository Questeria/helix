...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,372 tests collected in restart 34 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,372 live tests collected** — restart 34 fix verification; rerun scoped pytest collection before publishing
