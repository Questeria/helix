...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,391 tests collected in restart 39 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,391 live tests collected** — restart 39 fix verification; rerun scoped pytest collection before publishing
