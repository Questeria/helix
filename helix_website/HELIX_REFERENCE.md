...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,376 tests collected in restart 35 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,376 live tests collected** — restart 35 fix verification; rerun scoped pytest collection before publishing
