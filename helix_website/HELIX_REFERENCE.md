...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,379 tests collected in restart 36 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,379 live tests collected** — restart 36 fix verification; rerun scoped pytest collection before publishing
