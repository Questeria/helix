...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,347 tests collected in restart 31 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,347 live tests collected** — restart 31 fix verification; rerun scoped pytest collection before publishing
