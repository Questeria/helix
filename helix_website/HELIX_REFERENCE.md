...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,386 tests collected in restart 38 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,386 live tests collected** — restart 38 fix verification; rerun scoped pytest collection before publishing
