...
│   │   ├── option.hx
│   │   └── autodiff.hx
│   ├── tests/          # 2,381 tests collected in restart 37 fix verification
│   │   ├── test_codegen.py
│   │   ├── test_parser.py
│   │   ├── test_match.py
│   │   ├── test_reflection.py
...
- **2,381 live tests collected** — restart 37 fix verification; rerun scoped pytest collection before publishing
