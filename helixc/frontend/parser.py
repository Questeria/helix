...
def parse(source: str, filename: str = "<input>",
    ...
    if include_stdlib:
        ...
        stdlib_files = ["transcendentals.hx", "option.hx", "result.hx", "vec.hx", "hashmap.hx", "autodiff.hx", "autodiff_reverse.hx", "tensor.hx", "nn.hx", "agi_memory.hx", "agi_search.hx", "agi_match.hx", "agi_world.hx"]
