#!/usr/bin/env bash
# build.sh -- compile the helixc-bootstrap seed (seed.c, source-available / non-commercial) using ONLY
...
# M2-Planet -> (this seed). The seed source is OURS (Helix Non-Commercial License; see /LICENSE); we
