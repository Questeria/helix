...
3. **GPU host launcher → DOCUMENTED TRUSTED-TOOL BOUNDARY (no FFI).** Here max-Helix and
   ...
   bootstrap already trusts. **All math is Helix-emitted PTX**; the launcher contains zero
   compute. Scopes #3/#6.
